  ...
  (t.adapters = {}),
    (e.tokenize = function (t, e, s) {
      ...
      for (i = 0; i < t.length; i++)
        (h = t.charAt(i)),
          ~e.indexOf(h) ? (a.push(o), (o = { i: h, path: "" })) : (o.path += h);
      return a.push(o), a;
    }),
    (e.prototype.parse = function () {
      var s,
        h,
        a = this.interfaces();
      a.length || i("Must define at least one adapter interface."),
        ~a.indexOf(this.keypath[0])
          ? ((s = this.keypath[0]), (h = this.keypath.substr(1)))
          : ("undefined" == typeof (s = this.options.root || t.root) &&
              i("Must define a default root adapter."),
            (h = this.keypath)),
        (this.tokens = e.tokenize(h, a, s)),
    ...
    (e.prototype.realize = function () {
      var t,
        ...
        i = !1;
      return (
        this.tokens.forEach(function (h, a) {
          s(e)
            ? ("undefined" != typeof this.objectPath[a]
                ? e !== (t = this.objectPath[a]) &&
                  (this.set(!1, h, t, this.update),
                  this.set(!0, h, e, this.update),
                  (this.objectPath[a] = e))
                : (this.set(!0, h, e, this.update), (this.objectPath[a] = e)),
              (e = this.get(h, e)))
            : (i === !1 && (i = a),
              (t = this.objectPath[a]) && this.set(!1, h, t, this.update));
        }, this),
        i !== !1 && this.objectPath.splice(i),
        e
      );
    }),
...
(function () {
  ...
  (t = {
    ...
    window.jQuery || window.$
      ? ((i = window.jQuery || window.$),
        (r = "on" in i.prototype ? ["on", "off"] : ["bind", "unbind"]),
        (e = r[0]),
        (n = r[1]),
        (t.Util = {
          bindEvent: function (t, n, r) {
            return i(t)[e](n, r);
          },
          unbindEvent: function (t, e, r) {
            return i(t)[n](e, r);
          },
          getInputValue: function (t) {
            ...
            return (
              (e = i(t)),
              "checkbox" === e.attr("type") ? e.is(":checked") : e.val()
            );
          },
        }))
      : (t.Util = {
        ...
        (t.parse = function (t, e) {
          ...
          for (u = [], s = t.length, i = 0, n = 0; s > n; ) {
            ...
            if (
              (i > 0 &&
                i > n &&
                u.push({ type: this.types.text, value: t.slice(n, i) }),
              (n = i + e[0].length),
              (i = t.indexOf(e[1], n)),
              0 > i)
            ) {
              (o = t.slice(n - e[1].length)),
                (r = u[u.length - 1]),
                (null != r ? r.type : void 0) === this.types.text
                  ? (r.value += o)
                  : u.push({ type: this.types.text, value: o });
              break;
            }
            (l = t.slice(n, i).trim()),
              u.push({ type: this.types.binding, value: l }),
              (n = i + e[1].length);
          }
          return u;
        }),
    ...
    (t.View = (function () {
      function e(e, i, n) {
        var r, o, u, l, h, a, p, d, c, f, b, v, m;
        for (
          this.els = e,
            this.models = i,
            null == n && (n = {}),
            this.update = s(this.update, this),
            this.publish = s(this.publish, this),
            this.sync = s(this.sync, this),
            this.unbind = s(this.unbind, this),
            this.bind = s(this.bind, this),
            this.select = s(this.select, this),
            this.traverse = s(this.traverse, this),
            this.build = s(this.build, this),
            this.buildBinding = s(this.buildBinding, this),
            this.bindingRegExp = s(this.bindingRegExp, this),
            this.options = s(this.options, this),
            this.els.jquery ||
          ...
          if (((o = c[h]), (this[o] = {}), n[o])) {
            f = n[o];
            for (r in f) (u = f[r]), (this[o][r] = u);
          }
          b = t["public"][o];
          for (r in b) (u = b[r]), null == (l = this[o])[r] && (l[r] = u);
        }
      ...
      return (
        (e.prototype.options = function () {
          var e, i, n, r, s;
          for (
            i = {}, s = t.extensions.concat(t.options), n = 0, r = s.length;
            r > n;
            n++
          )
            (e = s[n]), (i[e] = this[e]);
        ...
        (e.prototype.buildBinding = function (e, i, n, r) {
          ...
          return (
            ...
            (s = (function () {
              var t, e, i, n;
              for (
                i = p.shift().split("<"), n = [], t = 0, e = i.length;
                e > t;
                t++
              )
                (o = i[t]), n.push(o.trim());
                ...
                return function (n) {
                  ...
                  if (3 === n.nodeType) {
                    if (
                      ...
                      (o = e.templateDelimiters) &&
                        (p = l.parse(n.data, o)).length &&
                        (1 !== p.length || p[0].type !== l.types.text))
                    ) {
                      for (d = 0, f = p.length; f > d; d++)
                        (a = p[d]),
                          ...
                          1 === a.type &&
                            e.buildBinding("TextBinding", h, null, a.value);
                  ...
                  if (!r)
                    for (
                      v = (function () {
                        var t, e, i, r;
                        for (
                          i = n.childNodes, r = [], t = 0, e = i.length;
                          e > t;
                          t++
                        )
                          (u = i[t]), r.push(u);
        ...
        (e.prototype.traverse = function (e) {
          ...
          for (m = n || e.attributes, d = 0, f = m.length; f > d; d++)
            (i = m[d]),
              s.test(i.name) &&
                ((h = i.name.replace(s, "")),
                this.buildBinding("Binding", e, h, i.value));
          return (
            o ||
              ((h = e.nodeName.toLowerCase()),
              this.components[h] &&
                !e._bound &&
                (this.bindings.push(new t.ComponentBinding(this, e, h)),
                (o = !0))),
            o
          );
        }),
        (e.prototype.select = function (t) {
          var e, i, n, r, s;
          for (r = this.bindings, s = [], i = 0, n = r.length; n > i; i++)
            (e = r[i]), t(e) && s.push(e);
          return s;
        }),
        (e.prototype.bind = function () {
          var t, e, i, n;
          for (n = this.bindings, e = 0, i = n.length; i > e; e++)
            (t = n[e]), t.bind();
        }),
    ...
    (t.Binding = (function () {
      function e(t, e, i, n, r) {
        (this.view = t),
          ...
          (this.eventHandler = s(this.eventHandler, this)),
          (this.formattedValue = s(this.formattedValue, this)),
          (this.parseFormatterArguments = s(
            this.parseFormatterArguments,
            this
          )),
          (this.parseTarget = s(this.parseTarget, this)),
          (this.observe = s(this.observe, this)),
          (this.setBinder = s(this.setBinder, this)),
      ...
      return (
        ...
        (e.prototype.parseTarget = function () {
          var e;
          return (
            (e = t.TypeParser.parse(this.keypath)),
            e.type === t.TypeParser.types.primitive
              ? (this.value = e.value)
        ...
        (e.prototype.parseFormatterArguments = function (e, i) {
          ...
          for (
            ...
            (r = e[n]),
              o.push(
                r.type === t.TypeParser.types.primitive
                  ? r.value
                  : ((u = this.formatterObservers)[i] || (u[i] = {}),
                    (s = this.formatterObservers[i][n])
                      ? void 0
                      : ((s = this.observe(
                          this.view.models,
                          r.value,
                        ...
                        (this.formatterObservers[i][n] = s)),
                    s.value())
              );
          return o;
        }),
        (e.prototype.formattedValue = function (t) {
          var e, i, n, r, s, u, l, h, a;
          for (h = this.formatters, i = u = 0, l = h.length; l > u; i = ++u)
            (n = h[i]),
              (e = n.match(/[^\s']+|'([^']|'[^\s])*'|"([^"]|"[^\s])*"/g)),
              (r = e.shift()),
              (n = this.view.formatters[r]),
              (s = this.parseFormatterArguments(e, i)),
              (null != n ? n.read : void 0) instanceof Function
                ? (t = (a = n.read).call.apply(
                    a,
                    [this.model, t].concat(o.call(s))
                  ))
                : n instanceof Function &&
                  (t = n.call.apply(n, [this.model, t].concat(o.call(s))));
          return t;
        }),
        ...
        (e.prototype.set = function (e) {
          ...
          return (
            (e =
              ...
              t["public"].executeFunctions
                ? this.formattedValue(e.call(this.model))
                : this.formattedValue(e)),
            null != (i = this.binder.routine)
              ? i.call(this, this.el, e)
              : void 0
          );
        }),
        (e.prototype.sync = function () {
              ...
              if (this.observer) {
                if (this.model !== this.observer.target) {
                  ...
                  if (
                    ...
                    for (
                      l = this.options.dependencies, n = 0, s = l.length;
                      s > n;
                      n++
                    )
                      (t = l[n]),
        ...
        (e.prototype.publish = function () {
          var t, e, i, n, r, s, u, l, h, a, p, d, c;
          if (this.observer) {
            for (
              l = this.getValue(this.el),
                s = this.formatters.length - 1,
                p = this.formatters.slice(0).reverse(),
                i = h = 0,
                a = p.length;
              a > h;
              i = ++h
              ...
              (n = p[i]),
                ...
                (t = n.split(/\s+/)),
                (r = t.shift()),
                (u = this.parseFormatterArguments(t, e)),
                (null != (d = this.view.formatters[r]) ? d.publish : void 0) &&
                  (l = (c = this.view.formatters[r]).publish.apply(
                    c,
                    [l].concat(o.call(u))
                  ));
        ...
        (e.prototype.bind = function () {
          ...
          if (
            ...
            null != this.model &&
              (null != (s = this.options.dependencies) ? s.length : void 0))
          )
            for (o = this.options.dependencies, i = 0, n = o.length; n > i; i++)
              (t = o[i]),
                (e = this.observe(this.model, t, this.sync)),
                this.dependencies.push(e);
        ...
        (e.prototype.unbind = function () {
          ...
          for (
            null != (o = this.binder.unbind) && o.call(this, this.el),
              null != (u = this.observer) && u.unobserve(),
              l = this.dependencies,
              r = 0,
              s = l.length;
            s > r;
      ...
      function i(e, i, n) {
        ...
        for (
          this.view = e,
            ...
            this.unbind = s(this.unbind, this),
            this.bind = s(this.bind, this),
            this.locals = s(this.locals, this),
            this.component = this.view.components[this.type],
            this["static"] = {},
            this.observers = {},
            this.upstreamObservers = {},
            o = e.bindingRegExp(),
            d = this.el.attributes || [],
            a = 0,
            p = d.length;
          p > a;
          a++
          ...
          (r = d[a]),
            o.test(r.name) ||
              ((u = this.camelCase(r.name)),
              (l = t.TypeParser.parse(r.value)),
              h.call(null != (c = this.component["static"]) ? c : [], u) >= 0
                ? (this["static"][u] = r.value)
                : l.type === t.TypeParser.types.primitive
                ? (this["static"][u] = l.value)
                : (this.observers[u] = r.value));
      }
      return (
        l(i, e),
        ...
        (i.prototype.bind = function () {
          ...
          if (null != this.componentView) this.componentView.bind();
            ...
            for (y = t.options, p = 0, c = y.length; c > p; p++)
              (s = y[p]),
                (o[s] = null != (g = this.component[s]) ? g : this.view[s]);
        ...
        if (null != window.jQuery) {
          ...
          if (null != e) {
            for (a = [], r = 0, s = t.length; s > r; r++)
              (n = t[r]),
                a.push((n.selected = ((u = n.value), h.call(e, u) >= 0)));
            return a;
          }
        } else if (
          (null != e ? e.toString() : void 0) !==
          (null != (l = t.value) ? l.toString() : void 0)
        )
    ...
    (t["public"].binders["if"] = {
      ...
      routine: function (e, i) {
        ...
        if (!!i == !this.bound) {
          ...
          return (
            e.parentNode.removeChild(e), this.nested.unbind(), (this.bound = !1)
          );
        }
      },
      update: function (t) {
    ...
    (t["public"].binders["each-*"] = {
      ...
      unbind: function () {
        ...
        if (null != this.iterated)
          for (n = this.iterated, e = 0, i = n.length; i > e; e++)
            (t = n[e]), t.unbind();
      },
      routine: function (e, i) {
        var n, r, s, o, u, l, h, a, p, d, c, f, b, v, m, y, g, w, k, x;
        if (
          ((h = this.args[0]), (i = i || []), this.iterated.length > i.length)
        )
          for (
            w = Array(this.iterated.length - i.length), f = 0, m = w.length;
            m > f;
            f++
          )
            (s = w[f]),
        ...
        if ("OPTION" === e.nodeName)
          for (x = this.view.bindings, v = 0, g = x.length; g > v; v++)
            (n = x[v]),
              n.el === this.marker.parentNode && "value" === n.type && n.sync();
      },
      update: function (t) {
        var e, i, n, r, s, o, u;
        e = {};
    ...
    (t["public"].formatters.call = function () {
      ...
      return (
        ...
        e.call.apply(e, [this].concat(o.call(t)))
      );
    }),
    (t["public"].adapters["."] = {
      id: "_rv",
      ...
      weakReference: function (t) {
        ...
        return (
          ...
          (i = this.weakmap)[(n = t[this.id])] || (i[n] = { callbacks: {} })
        );
      },
          ...
          (t[e] = function () {
            ...
            for (o in a)
              for (
                s = a[o],
                  c =
                    null != (p = null != (d = r[o]) ? d.callbacks[s] : void 0)
                      ? p
                      : [],
                  l = 0,
                  h = c.length;
      ...
      observeMutations: function (t, e, i) {
        ...
        if (Array.isArray(t)) {
          ...
          if (
            (null == (o = s.pointers)[e] && (o[e] = []),
            h.call(s.pointers[e], i) < 0)
          )
